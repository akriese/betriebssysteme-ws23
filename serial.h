 ...
 *
 * The controller has to be enabled before the start of the string send and disabled
 * afterwards, but not inbetween, as multiple characters can be sent in a row.
 */
